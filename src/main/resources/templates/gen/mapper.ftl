package ${myClass.moudleName}.mapper;

import ${myClass.moudleName}.entity.${myClass.entityName};
import java.util.List;
/*
* @ClassName: ${myClass.className}
* @Description: ${myClass.tableComment}mapper接口
...
public interface ${myClass.className} {
        ...
        * @return
        */
        int insert(${myClass.entityName} ${'${myClass.entityName}'?uncap_first});
        ...
        */
        ...
        /**
        * 根据<#list myClass.fieldList as field><#if field_index==0>${field.fieldName}</#if></#list>查询${myClass.tableComment}
        * @param <#list myClass.fieldList as field><#if field_index==0>${field.fieldName}</#if></#list>
        * @return
        */
        ...
        * @return
        */
        int selectCountById(<#list myClass.fieldList as field><#if field_index==0>${field.fieldType}</#if></#list> <#list myClass.fieldList as field><#if field_index==0>${field.fieldName}</#if></#list>);
        }